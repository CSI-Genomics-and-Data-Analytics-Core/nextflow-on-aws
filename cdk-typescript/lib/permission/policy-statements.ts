...
export class GedacPermissions {
    ...
    iam() : PolicyStatement[] {
        ...
        return [
            new PolicyStatement({
                ...
                resources: [
                    this.arn({service: svc, region: "", resource: "role", resourceName: "Gedac-*"}),
                    this.arn({service: svc, region: "", resource: "instance-profile", resourceName: "Gedac-*"}),
                    this.arn({service: svc, region: "", resource: "role", resourceName: "cdk-gedac-*"}),
                ]
            }),
            new PolicyStatement({
    ...
    private cloudformationCommon() {
        ...
        return new PolicyStatement({
            ...
            resources: [
                this.arn({service: "cloudformation", region: "*", resource: "stack", resourceName: "Gedac-*"}),
            ]
        })
    }
    ...
    elb() : PolicyStatement[] {
        ...
        return [
            new PolicyStatement({
                ...
                resources: [
                    this.arn({service: svc, region: "*", resource: "loadbalancer/net", resourceName: "Gedac-*"}),
                    this.arn({service: svc, region: "*", resource: "listener/net", resourceName: "Gedac-*"}),
                    this.arn({service: svc, region: "*", resource: "targetgroup", resourceName: "Gedac-*"}),
                ]
            }),
            new PolicyStatement({
                effect: Effect.ALLOW,
    ...
    logs() : PolicyStatement[] {
        ...
        return [
            new PolicyStatement({
                ...
                resources: [
                    this.arn({service: svc, region: "*", resource: "log-group:Gedac*"}),
                    this.arn({service: svc, region: "*", resource: "log-group:Gedac*"}),
        ...
        return [
            ...
            new PolicyStatement({
                ...
                resources: [
                    ...
                    this.arn({service: "ecs", resource: "cluster", resourceName: "Gedac*"}),
                    this.arn({service: "ecs", resource: "service", resourceName: "Gedac*"}),
                    this.arn({service: "ec2", resource: "launch-template", resourceName: "*"}),
                    this.arn({service: "elasticloadbalancing", resource: "*", resourceName: "Gedac*"}),
