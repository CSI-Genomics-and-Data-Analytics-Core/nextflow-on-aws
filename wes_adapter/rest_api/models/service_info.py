...
class ServiceInfo(Model):
    ...
    def __init__(
        self,
        workflow_type_versions=None,
        supported_wes_versions=None,
        supported_filesystem_protocols=None,
        workflow_engine_versions=None,
    ...
    def workflow_engine_versions(self):
        ...
        The engine(s) used by this WES service, key is engine name (e.g. Nextflow) and value is version  # noqa: E501
